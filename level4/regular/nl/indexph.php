<?php
$db=mysqli_connect('localhost', 'root', 'qwerty', 'bdnl');
...
//$pattern1="/(?<!\w)(?:(?:(?:(?:\+?0)?1\W{0,3})?0\W{0,3})?[0-9]\s?\d[^\w,;(\+]{0,5})?\d\W{0,5}\d\W{0,3}\d\W{0,3}\d\W{0,3}\d\W{0,3}\d\W{0,3}\d(?!(\W?\d))/ux";
    $pattern1="/(?<!\w)(?:(?:(?:(?:?\+0)?0[^A-Za-z0-9_.,%=#:<>]{0,3})?0[^A-Za-z0-9_.,%=#:<>]{0,3})?[0-9]\s?\d[^\w,;(\+]{0,5})?\d[^A-Za-z0-9_.,%=#:<>]{0,5}\d[^A-Za-z0-9_.,%=#:<>]{0,3}\d[^A-Za-z0-9_.,%=#:<>]{0,3}\d[^A-Za-z0-9_.,%=#:<>]{0,3}\d[^A-Za-z0-9_.,%=#:<>]{0,3}\d[^A-Za-z0-9_.,%=#:<>]{0,3}\d(?!([^A-Za-z0-9_.,%=#:<>]{0,3}?\d))/x";
